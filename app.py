...
def _run_dialogue_generation(
    ...
    dummy: str = "",  # 🔧 FIX: dummy parameter to absorb the extra argument
    ...
    with gr.Blocks(title="arabic-TTS Dialogue") as demo:
        ...
        **طريقة الاستخدام:**
        ...
        with gr.Row():
            ...
            tone2 = gr.Dropdown(label="نبرة الرقم 2", choices=TONE_CHOICES, value="نبرة اخباريه")
        ...
        # 🔧 FIX: hidden dummy component to provide the 29th input
        dummy = gr.Textbox(visible=False, value="")
